...
This eBook will be updated occasionally so please periodically check the [leanpub.com web page for this book](https://leanpub.com/PrologAI) for updates.

Please visit the [author's website](https://markwatson.com).

If you found a copy of this book on the web and find it of value then please consider buying a copy at [leanpub.com/PrologAI](https://leanpub.com/PrologAI).
...
**Note: Dear reader, although I have been a Prolog enthusiast since the 1980s I have only four or five months of professional Prolog development experience. I used DeepSeek v4 (with some use of Gemini 3, and Claude Opus models) for developing and debugging the example programs and for editing the text for this book.**
...
[https://github.com/mark-watson/PrologAIBook](https://github.com/mark-watson/PrologAIBook)

## Acknowledgments

I would like to thank my wife Carol for editing this book. I would like to thank the following readers for reporting errors: David Rupp.
