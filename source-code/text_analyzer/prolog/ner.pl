...
person_name('Reagan').
person_name('Kennedy').
person_name('Roosevelt').
person_name('Lincoln').
person_name('Jefferson').
person_name('Hamilton').
person_name('Franklin').
person_name('Churchill').
person_name('Thatcher').
person_name('Gandhi').
person_name('Mandela').
person_name('Einstein').
person_name('Newton').
person_name('Darwin').
person_name('Hemingway').
person_name('Austen').
person_name('Dickens').
person_name('Plato').
person_name('Aristotle').
person_name('Socrates').
person_name('Napoleon').
person_name('Caesar').
person_name('Columbus').
person_name('Gates').
person_name('Musk').
person_name('Turing').
...
org_name('United_Nations').
org_name('NATO').
org_name('European_Union').
org_name('Google').
org_name('Microsoft').
org_name('Apple').
